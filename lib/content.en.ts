    ...
    steps: [
      {
        ...
        options: [
          { value: 'reporting',    label: 'Analysis & reporting' },
          { value: 'emails',       label: 'Writing & emails' },
          { value: 'decisions',    label: 'Slow decision-making' },
          { value: 'organisation', label: 'Internal organization' },
      ...
      },
      {
        ...
        options: [
          { value: 'moins-5h', label: 'Less than 5h' },
          { value: '5-10h',    label: '5 to 10h' },
          { value: '10-20h',   label: '10 to 20h' },
          { value: '20h+',     label: 'More than 20h — every week' },
        ],
      },
      {
        id: 3,
      ...
      },
      {
        ...
        hint: 'Multiple choices possible',
        options: [
          { value: 'temps',     label: 'Save time' },
          { value: 'pression',  label: 'Reduce pressure' },
          { value: 'decisions', label: 'Speed up decisions' },
          { value: 'recruter',  label: 'Avoid hiring' },
        ],
      },
      {
        id: 5,
        ...
        options: [
          { value: 'jamais',        label: 'No, not yet' },
          { value: 'partiellement', label: 'Yes, partially' },
          { value: 'echec',         label: 'Yes, without success' },
        ],
      },
      {
        id: 6,
        ...
        options: [
          { value: 'tester',      label: 'Test a first improvement' },
          { value: 'ameliorer',   label: 'Improve overall efficiency' },
          { value: 'transformer', label: 'Transform the organization' },
        ],
      },
    ] as DiagStep[],
