...
// Section témoignages — reveal staggeré
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {content.testimonials.map((t, index) => (
            <RevealOnScroll key={index} delay={index * 0.15}>
              <div className="border border-white/[0.08] p-6 md:p-8 lg:p-10 flex flex-col justify-between h-full hover:border-accent/20 transition-colors duration-300">
                <span
                  aria-hidden="true"
                ...
                <p className="font-grotesk font-medium text-surface text-xl md:text-2xl leading-snug tracking-tight italic flex-1 mb-8">
                  {t.quote}
                </p>
