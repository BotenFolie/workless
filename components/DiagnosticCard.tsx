          ...
          {view === 'contact' && (
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                {([
                  ...
                  <div key={f.key}>
                    <label className="block font-inter text-[9px] font-semibold tracking-[0.12em] uppercase text-surface/35 mb-1.5">
                      ...
                      {!f.required && (
                        <span className="normal-case font-normal tracking-normal ml-1 text-surface/20">
                          {d.optional}
                        </span>
                      )}
                    </label>
                    <input
                      ...
                      placeholder={d.fields[f.key].placeholderSm}
                      value={contact[f.key]}
                ...
                >
                  {loading ? (
                    <><span className="w-3 h-3 border-2 border-bg/30 border-t-bg rounded-full animate-spin" />{d.loadingSm}</>
                  ) : d.submit}
                </button>
              </form>
            </motion.div>
